...
public class BE2_Cst_HarvestXFromYAction : BE2_InstructionBase, I_BE2_Instruction

{
...

    {
        ...
        string raw = Section0Inputs[0].StringValue;
        string listName = Section0Inputs[1].StringValue;
