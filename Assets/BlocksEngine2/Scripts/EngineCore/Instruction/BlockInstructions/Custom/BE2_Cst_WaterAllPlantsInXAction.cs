...
public class BE2_Cst_WaterAllPlantsInXAction : BE2_InstructionBase, I_BE2_Instruction

{
...

    {
        ...
        string fieldName = Section0Inputs[0].StringValue;
        if (TargetObject is Interpreter i)
        {
            i.WaterAllPlants(fieldName);
        }
