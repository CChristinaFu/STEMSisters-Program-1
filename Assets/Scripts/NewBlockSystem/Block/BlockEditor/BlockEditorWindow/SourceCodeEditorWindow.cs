...
public class SourceCodeEditorWindow : BlockEditorWindow
{
    public static SourceCodeEditorWindow instance;
    ...
    [SerializeField]
    private TMP_Text BlockCategoryTextPrefab;
    private void SortBlockEditorUnitsInBlockShop()
    {
        foreach (var key in this.BlockEditorUnitsInBlockShop.Keys.ToArray())
        {
            ...
            TMP_Text blockCategoryText = Instantiate(BlockCategoryTextPrefab.gameObject).GetComponent<TMP_Text>();
