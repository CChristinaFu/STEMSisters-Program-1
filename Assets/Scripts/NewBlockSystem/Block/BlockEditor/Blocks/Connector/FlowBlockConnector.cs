...
public class FlowBlockConnector : BlockEditorElement, IAttachableEditorElement
{
    ...
    public void CreateFlowBlockMockUp(FlowBlockEditorUnit flowBlockEditorUnit, int siblingIndex = 0)
    {
        ...
        BlockMockupHelper spawnedMockUp = PoolManager.SpawnObject(SourceCodeEditorWindow.instance.BlockMockUpPrefab).GetComponent<BlockMockupHelper>();
        SourceCodeEditorWindow.instance.AddToSpawnedBlockMockUp(spawnedMockUp);
