...
public abstract class FlowBlock : Block
{
    ...
    public virtual float GetDurationTime(Interpreter operatingRobotBase)
    {
        return 1;
    }
    ...
    */
    ...
    public bool IsOperatable(Interpreter operatingRobotBase)
    {
    ...
    private bool IsOperatable(Interpreter operatingRobotBase, float durationTime)
    {
        return operatingRobotBase.WaitingTime >= durationTime - Mathf.Epsilon;
    }
    ...
    /// </returns>
    public FlowBlock StartFlowBlock(Interpreter operatingRobotBase)
    {
        float durationTime = this.GetDurationTime(operatingRobotBase);
    ...
    /// </returns>
    public virtual FlowBlock EndFlowBlock(Interpreter operatingRobotBase)
    {
        return this.NextBlock;
    }

    public abstract void Operation(Interpreter operatingRobotBase);
