...
public sealed class DefinitionFourParameterCustomBlock : DefinitionCustomBlock, IContainingParameter<LiteralReporterBlock, LiteralReporterBlock, LiteralReporterBlock, LiteralReporterBlock>
{
    ...
    public void CopyParamter(Interpreter interpreter, ReporterBlock passedReporterBlock1, ReporterBlock passedReporterBlock2, ReporterBlock passedReporterBlock3, ReporterBlock passedReporterBlock4)
    {
        this.Input1 = new LiteralReporterBlock(passedReporterBlock1.GetReporterStringValue(interpreter)); // 
        this.Input2 = new LiteralReporterBlock(passedReporterBlock2.GetReporterStringValue(interpreter)); // 
        this.Input3 = new LiteralReporterBlock(passedReporterBlock3.GetReporterStringValue(interpreter)); // 
        this.Input4 = new LiteralReporterBlock(passedReporterBlock4.GetReporterStringValue(interpreter)); // 
    }
